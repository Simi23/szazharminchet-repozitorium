...
!
!
username Administrator privilege 15 secret 9 $9$t8paqjmbTflfo9$fFXgCgWcjnYV3oALNMzZA4HsH9oK4cDuEdg21Rn7B0I
!
redundancy
!
!
...
!
interface GigabitEthernet0/2
ip address 10.252.0.5 255.255.255.252
duplex auto
speed auto
media-type rj45
!
...
neighbor 10.252.0.2 remote-as 8654
neighbor 10.252.0.2 route-reflector-client
neighbor 10.252.0.6 remote-as 8654
neighbor 10.252.0.6 route-reflector-client
!
ip forward-protocol nd
!
!
...
!
!
username Administrator privilege 15 secret 9 $9$Uaoy/UDeOFPMmP$DXyRa/T.zB5gwvCqaCCHDfcED39r35HsJzGNNuBlURY
!
redundancy
!
!
...
!
interface GigabitEthernet0/1
ip address 80.200.200.1 255.255.255.252
duplex auto
speed auto
media-type rj45
!
interface GigabitEthernet0/2
ip address 80.200.200.5 255.255.255.252
duplex auto
speed auto
media-type rj45
!
...
network 80.200.200.0 mask 255.255.255.252
network 80.200.200.4 mask 255.255.255.252
neighbor EBGP peer-group
neighbor EBGP password Passw0rd!
neighbor EBGP route-map DEFAULT out
neighbor 10.252.0.1 remote-as 8654
neighbor 80.200.200.2 remote-as 65002
neighbor 80.200.200.2 peer-group EBGP
neighbor 80.200.200.6 remote-as 65001
neighbor 80.200.200.6 peer-group EBGP
!
ip forward-protocol nd
!
!
...
!
!
username Administrator privilege 15 secret 9 $9$DTGEYOXR/qr55f$b6UwrU9Nb3V0hpRRRWRT9X1I/nHEyaN7ltZuYd33lFk
!
redundancy
!
!
...
!
interface GigabitEthernet0/0
ip address 80.200.200.14 255.255.255.252
duplex auto
speed auto
media-type rj45
!
interface GigabitEthernet0/1
vrf forwarding herningco
ip address 192.168.15.254 255.255.254.0
duplex auto
speed auto
media-type rj45
!
...
neighbor 80.200.200.13 remote-as 8654
neighbor 80.200.200.13 password Passw0rd!
!
ip forward-protocol nd
!
!
...
!
!
ip dhcp excluded-address 172.32.23.254
!
ip dhcp pool BRANCH2
vrf herningco
network 172.32.20.0 255.255.252.0
domain-name herning.co
default-router 172.32.23.254
lease 7
!
!
!
...
!
!
username Administrator privilege 15 secret 9 $9$Ph9Fpyomz9PXgv$.jMvxzKUUis/QCzNT0PgWcGazPf2C8ccwXzDcNXqZIE
!
redundancy
!
!
...
!
interface GigabitEthernet0/0
ip address 80.200.200.2 255.255.255.252
duplex auto
speed auto
media-type rj45
!
interface GigabitEthernet0/1
vrf forwarding herningco
ip address 172.32.23.254 255.255.252.0
duplex auto
speed auto
media-type rj45
!
...
router ospf 10 vrf herningco
network 10.0.0.0 0.0.0.255 area 0
network 172.32.20.0 0.0.3.255 area 0
!
router bgp 65002
bgp log-neighbor-changes
network 5.5.5.5 mask 255.255.255.255
neighbor 80.200.200.1 remote-as 8654
neighbor 80.200.200.1 password Passw0rd!
!
ip forward-protocol nd
!
!
